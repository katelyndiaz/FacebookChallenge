...
class FacebookProfile {
    ...
    /*****YOUR CODE GOES HERE*****/
    func setFriendCount(input: Int) {
        friendCount = input
    }
    func setBDay(input: String) {
        bDay = input
    }
    func setSpecialFriend(input: String) {
        specialFriend = input
    }
...
var facebookProfileInfo = FacebookProfile(name2: "Emma Smith", username2: "emmaSmith", bio2: "Sad", friendCount2: 1, bDay2: "01/02/01", specialFriend2: "No one")

print(facebookProfileInfo.username)
//What is the purpose of the above statement????????????????????????

facebookProfileInfo.friendly(name: "Emma Smith", username: "emmaSmith", bio: "sad", friendCount: 1, bDay: "01/02/01", specialFriend: "no one")
